...
| Ex Libris case — first override probe | none sent, stored `972TAU0075707` | `43257185010004146` | SHEB | ✅ yes (cancelled, **not** removed) | 2026-09-14 |
| Ex Libris case — second override probe | none sent, stored `972TAU0075708` | `43257186260004146` | ASAF | ❌ **kept live** — superseded by the BEIL pair below and named nowhere, but the operator ruled on 2026-09-14 that SANDBOX leftovers from this case stay put. Do not cancel | 2026-09-14 |
| **Ex Libris case — call A** (no override) | — | — (create rejected, `401604`; nothing to clean) | BEIL | n/a | 2026-09-14 |
| **Ex Libris case — call B** (`override_blocks=true`) | none sent, stored `972TAU0075709` | **`43257186940004146`** | BEIL | ❌ **kept live deliberately** — the one request named in the document sent to Ex Libris on 2026-09-14 (docs/exlibris-case-401604-report.md §6.3), and the one they may open at any time. **Do not cancel until the case closes** | 2026-09-14 |
